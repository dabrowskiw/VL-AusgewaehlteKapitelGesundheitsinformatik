...
\begin{frame}{Sourcecodeverwaltung (git)}
    \begin{minipage}{.4\textwidth}
		\begin{mdframed}[bgcolor=white]
			\begin{figure}[h!]
				\includegraphics[height=5.5cm]{Kapitel/TechnischeGrundlagen/Bilder/gitbranching2.png}
    ...
    \only<2->{
        \begin{textblock}{6}(10,0.2)
            \begin{figure}[h!]
                \includegraphics[height=7.3cm, left]{Kapitel/TechnischeGrundlagen/Bilder/gitbranching.png}
