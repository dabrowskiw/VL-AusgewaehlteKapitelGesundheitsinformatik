...
\begin{frame}[fragile]{\only<1-4,6->{Python}}
    ...
    \begin{itemize}
		\item Cheat Sheet: \href{https://www.dataquest.io/blog/python-cheat-sheet/}{https://www.dataquest.io/blog/python-cheat-sheet/}
        \item<2-> Interpretierte Sprache
        \item<5-> Multi-paradigm: Objektorientiert, mit funktionalen Elementen
        \item<5-> Typisierung: Dynamisch, stark (dynamically, strongly typed)
        \item<7-> Automatisches Speichermanagement
        \item<8-> Designziel: Einfach zu lesen und zu schreiben, prägnant (wenig boilerplate code)
        \item<8-> Einrückung statt Klammern
    \end{itemize}
    \only<3>{
